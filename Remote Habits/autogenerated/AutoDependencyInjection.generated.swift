 ...
 class DI {
    ...
    */
     func inject<T>(_ dep: Dependency) -> T {                            
        switch dep {
            ...
            case .habitDataManager: return self.habitDataManager as! T 
    ...
    */
    ...
    private var newDeepLinksHandlerUtil: DeepLinksHandlerUtil {    
        return AppDeepLinksHandlerUtil(userManager: self.userManager)
    }
    // Logger
    ...
    internal var habitDataManager: HabitDataManager {    
        if let overridenDep = self.overrides[.habitDataManager] {
            return overridenDep as! HabitDataManager
        }
        return self.newHabitDataManager
    }
    private var newHabitDataManager: HabitDataManager {    
        return HabitDataManager()
    }
