...
struct Constants {
    ...
    static let kConfigureSdk = "Configure SDK"
    ...
    static let kSwitchWorkspacePreLoginIdentifier = "SwitchWorkspacePreLoginIdentifier"
    ...
    static let kConfigureCioSdkViewController = "ConfigureCioSdkViewController"
