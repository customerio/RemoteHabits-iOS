...
generate:
	sourcery --sources "Remote Habits" --templates "Remote Habits/Templates" --output "Remote Habits/autogenerated" --args imports=CioTracking-CioMessagingPush

lint:
	make format && swiftlint lint --strict
